...
const OrderList = ({api}) => {
    ...
    const handleConfirm = (orderId) => {
        fetch(`${endpoint}/orders/${orderId}/confirm`, {
            method: "PATCH",
            headers: {
                'Authorization': `Bearer ${user?.accessToken}`,
                'Content-Type': 'application/json',
                                                ...
                                                </div>
                                                {
                                                    ...
                                                    (
                                                        <div className="mt-2 flex flex-row-reverse">
                                                            <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Huỷ đơn hàng</button>
