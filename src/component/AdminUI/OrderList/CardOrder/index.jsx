...
const CardOrder = (props) => {
    ...
    return (
        <div className="mt-2 rounded-lg p-3 border flex gap-3">
            <div className="w-[110px] h-[110px]">
                <Image src="https://firebasestorage.googleapis.com/v0/b/imgaeproject.appspot.com/o/images%2Frc-upload-1717084950125-3?alt=media&token=2d8fc153-9580-45c0-94d9-8032c7ef35a8" />
            </div>
